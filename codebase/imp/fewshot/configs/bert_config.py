...
class BasicConfig(object):
  """Standard CNN on BERT with prototypical layer. (Is this needed)"""

  def __init__(self):
    self.name = "bert_basic"
...
@RegisterConfig("bert", "kmeans-refine")
class KMeansRefineConfig(BasicConfig):
  ...
  def __init__(self):
    ...
    self.name = "bert-kmeans-refine-learn-sigmal-" + str(self.learn_sigma_l)

@RegisterConfig("bert", "kmeans-distractor")
class KMeansDistractorConfig(BasicConfig):
  ...
  def __init__(self):
    ...
    self.name = "bert-"+self.model_class+"-learn-sigmau-" + str(self.learn_sigma_u) + "-learn-sigmal-" + str(self.learn_sigma_l)

@RegisterConfig("bert", "imp")
...
@RegisterConfig("bert", "dp-means-hard")
